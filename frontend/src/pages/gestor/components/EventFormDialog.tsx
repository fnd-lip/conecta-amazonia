...
function EventFormDialog({
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Steps Indicator */}
      <div className="flex items-center justify-center mb-2 pb-2 border-b-2 border-gray-200">
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="text-sm font-medium">Dados do Evento</span>
          </div>
      ...
      <div className="h-full">
        {currentStep === 1 && (
          ...
          >
            <ScrollArea className="h-[calc(83vh-200px)]">
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-2 md:col-span-2">
                    ...
                    <select
                      ...
                      disabled={loading}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-purple-600 focus:ring-2 focus:ring-purple-600/10 disabled:bg-gray-100 disabled:cursor-not-allowed"
                    >
                  ...
                  <div className="flex flex-col gap-2 md:col-span-2">
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      disabled={loading}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-purple-600 focus:ring-2 focus:ring-purple-600/10 disabled:bg-gray-100 disabled:cursor-not-allowed resize-y min-h-25"
                      required
                    />
                  </div>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col gap-2 md:col-span-2">
                    <label className="text-sm font-medium text-gray-700">
                      Links relacionados (separe por vírgula)
                    </label>
                    <Input
                      type="text"
                      name="relatedLinks"
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-2 md:col-span-2">
                    ...
                    />
                    {isSearchingLocation && (
                      <div className="p-2 bg-gray-100 rounded-md text-sm text-gray-500 mt-2">
                        Buscando endereços...
                      </div>
                    )}
                    {!isSearchingLocation &&
                    ...
                    {locationResults.length > 0 && (
                      <div className="mt-2 border border-gray-300 rounded-md max-h-50 overflow-y-auto bg-white">
                        {locationResults.map((result) => (
                          <button
                            key={`${result.lat}-${result.lon}`}
                            type="button"
                            className="w-full p-3 text-left border-b border-gray-200 last:border-b-0 hover:bg-gray-100 transition-colors text-sm"
                  ...
                  <div className="flex flex-col gap-2 md:col-span-2">
                    ...
                    />
                    {selectedLocation && (
                      <div className="mt-2 p-2 bg-green-50 border border-green-300 rounded-md text-sm text-green-800 font-mono">
              ...
              {success && (
                <div className="p-4 bg-green-50 border border-green-300 rounded-md text-green-800 mt-6 font-medium">
                  ✅ {success}
              ...
              {error && (
                <div className="p-4 bg-red-50 border border-red-300 rounded-md text-red-800 mt-6 font-medium">
                  ❌ {error}
                </div>
              )}
            </ScrollArea>
            <div className="flex flex-col md:flex-row gap-2 justify-end mt-2 pt-2 border-t-2 border-gray-200">
              {onCancel && (
        ...
        {currentStep === 2 && (
          <div className="w-full h-full flex flex-col justify-between">
            <ScrollArea className="h-[calc(89vh-200px)]">
              <TicketLotManager
